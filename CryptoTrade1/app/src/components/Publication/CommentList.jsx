...
const CommentList = ({ post_id, updateTabs, setUpdateTabs }) => {
    ...
    useEffect(() => {
        const fetchComments = async () => {
            try {
                const postComments = await getCommentsByPostId(post_id);
    ...
    return (
        <div className="max-w-screen-lg flex w-full justify-start flex-col ">
            {comments.map(comment => (
                <div key={comment._id} className="flex items-start flex-col ">
                        ...
                        <div className="flex w-full flex-col pr-20">
                            ...
                            <div className="flex w-full items-center text-sm justify-between">
                                ...
                                >
                                    ...
                                    <p className="text-white ml-3">{comment.comments.length}</p>
                                </div>
                                ...
                                <div className="cursor-pointer opacity-70 hover:opacity-100 flex items-center mr-4">
                                    ...
                                    <p className="text-white ml-3">{comment.reposts.length}</p>
                                </div>
                                ...
                                <div className="cursor-pointer opacity-70 hover:opacity-100 flex items-center mr-4">
                                    ...
                                    <p className="text-white ml-3">{comment.reactions.length}</p>
                                </div>
